...
/* ───────── helpers de tiempo (alineados con coupons.js) ───────── */
...
/* ───────── cálculo de descuento del NUEVO sistema ───────── */
...
module.exports = (prisma) => {
   ...
   *  (No canjea cupones; lo hace el webhook)
   * ============================================================ */
  ...
  /* ============================================================
   *  C) Webhook Stripe — ÚNICO punto de CANJE
   * ============================================================ */
  router.post(
    '/stripe/webhook',
